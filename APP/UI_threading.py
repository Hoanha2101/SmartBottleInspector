...
def threading_camera_1(frame_1, start_time):
    with ThreadPoolExecutor() as executor:
        frame_1, ID_DEFAULT_1, ERROR_DEFAULT_1 = executor.submit(CHECK_BOTTLE_AI, frame_1, start_time).result()
        print(frame_1, ID_DEFAULT_1, ERROR_DEFAULT_1)
        COMBINATION[0] = [frame_1, ID_DEFAULT_1, ERROR_DEFAULT_1]
    
def threading_camera_2(frame_2, start_time):
    with ThreadPoolExecutor() as executor:
        frame_2, ID_DEFAULT_2, ERROR_DEFAULT_2 = executor.submit(CHECK_WATER_LEVEL_AI, frame_2, start_time).result()
        COMBINATION[1] = [frame_2, ID_DEFAULT_2, ERROR_DEFAULT_2]

def threading_camera_3(frame_3, start_time):
    with ThreadPoolExecutor() as executor:
        frame_3, ID_DEFAULT_3, ERROR_DEFAULT_3 = executor.submit(CHECK_LABEL_AI, frame_3, start_time).result()
        COMBINATION[2] = [frame_3, ID_DEFAULT_3, ERROR_DEFAULT_3]
...
while running:
    ...
    # Tạo ba luồng cho hai hàm
    thread_camera_1 = threading.Thread(target=threading_camera_1, args=(frame_1, start_time,))
    thread_camera_2 = threading.Thread(target=threading_camera_2, args=(frame_2, start_time,))
    thread_camera_3 = threading.Thread(target=threading_camera_3, args=(frame_3, start_time,))
...
# Quản lí frame 1 ---------------------------------------------------------------------------------------         
    if ret_1:
        ...
        if ACTIVE_AI_camera_1 == True:
            ...
            frame_1, ID_DEFAULT_1, ERROR_DEFAULT_1 = COMBINATION[0]
...
# Quản lí frame 2 ---------------------------------------------------------------------------------------    
    if ret_2:
        ...
        if ACTIVE_AI_camera_2 == True:
            ...
            frame_2, ID_DEFAULT_2, ERROR_DEFAULT_2 = COMBINATION[1]
...
# Quản lí frame 3 ---------------------------------------------------------------------------------------      
    if ret_3:
        ...
        if ACTIVE_AI_camera_3 == True:
            thread_camera_3.start()
            thread_camera_3.join()
            frame_3, ID_DEFAULT_3, ERROR_DEFAULT_3 = COMBINATION[2]
