...
#     # Resize ảnh về kích thước 224x224 (kích thước mà model ResNet18 yêu cầu)
#     resized_image = cv2.resize(image, (90, 270))
#     # Chuẩn hóa giá trị pixel về dạng float trong khoảng [0, 1]
#     resized_image = resized_image.astype(np.float32) / 255.0
#     # Thêm một chiều cho ảnh để phù hợp với input của mạng
