...
def sigmoid(z):
    ...
    # Compute sigmoid using tf.keras.activations.sigmoid
...
    Returns:
    ...
    # YOUR CODE STARTS HERE
    # Compute one hot encoding using tf.one_hot
    one_hot = tf.one_hot(label, depth=C)
    
    # Reshape the one hot tensor and convert it to a 1D array
...
def compute_total_loss(logits, labels):
    ...
    # Sum the losses across the examples
